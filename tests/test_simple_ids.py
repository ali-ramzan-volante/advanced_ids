...
class FirewallTests(unittest.TestCase):
    ...
    def test_ipv4_rule_uses_argument_list(self, run, _geteuid):
        ...
        self.assertEqual(run.call_args_list[0].args[0], ["iptables", "-C", "INPUT", "-s", "203.0.113.10", "-j", "DROP"])
      
        self.assertEqual(run.call_args_list[1].args[0], ["iptables", "-A", "INPUT", "-s", "203.0.113.10", "-j", "DROP"])
